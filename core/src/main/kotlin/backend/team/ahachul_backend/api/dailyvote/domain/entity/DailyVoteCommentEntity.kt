...
@Entity
@Table(name = "tb_daily_vote_comment")
class DailyVoteCommentEntity(
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column(name = "daily_vote_comment_id")
    val id: Long = 0,
    ...
    var status: DailyVoteCommentStatusType,
) : BaseEntity() {
    ...
    fun delete() {
        status = DailyVoteCommentStatusType.DELETED
    }
}
