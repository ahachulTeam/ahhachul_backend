                ...
                document(
                    ...
                    PayloadDocumentation.responseFields(
                        *commonResponseFields(),
                        ...
                        fieldWithPath("result.places[].operatingHours").type(JsonFieldType.STRING).description("운영시간 텍스트"),
                        fieldWithPath("result.places[].crowdLevel").type(JsonFieldType.STRING).description("혼잡도 레벨(LOW/MEDIUM/HIGH/VERY_HIGH)"),
                        fieldWithPath("result.places[].crowdUpdatedAt").type(JsonFieldType.STRING).description("혼잡도 갱신 시각"),
                        ...
                        fieldWithPath("result.places[].poiAccuracyScore").type(JsonFieldType.NUMBER).description("POI 정확도 점수(0~100)"),
                        fieldWithPath("result.places[].poiAccuracyReason").type(JsonFieldType.STRING).description("POI 정확도 근거"),
