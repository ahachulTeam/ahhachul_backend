                ...
                document(
                    ...
                    responseFields(
                        *commonResponseFields(),
                        ...
                        fieldWithPath("result.bookmarkCnt").type(JsonFieldType.NUMBER).description("북마크 수"),
                        ...
                        fieldWithPath("result.bookmarkYn").type("YNType").description("북마크 여부").attributes(getFormatAttribute("Y, N")),
